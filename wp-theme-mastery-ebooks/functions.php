...
function mastery_ebooks_scripts() {
    ...
    wp_localize_script('mastery-ebooks-main', 'supabaseConfig', array(
        'url' => 'https://cghrmeckjzjzgpgcgiot.supabase.co',
        'key' => 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNnaHJtZWNranpqemdwZ2NnaW90Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODk0OTc3MDUsImV4cCI6MjEwNTA3MzcwNX0.sIM_w8C31JwXJq2bm2h-69hhAOehBYuWtTUEUqKItyM'
    ));
}
